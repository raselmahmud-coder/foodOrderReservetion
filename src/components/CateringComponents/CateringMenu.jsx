    ...
    <>
      <section>
        ...
        <p className="text-xl text-center text-gray-100 w-[75%] pt-12 mx-auto">
          ...
          dining experience from your location! We offer many options in regards
          to menus, which are completely customizable based on your needs and
          preferences. For those who prefer a quick pick up/delivery, please use
          the link to EZ Cater. For larger caterings or full-service events,
          please reach out via event inquiry and we will reach out to you as
          soon as possible.
        </p>
